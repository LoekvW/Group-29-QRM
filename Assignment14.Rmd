...
It is a sample of a larger population, the full population would include every single movie made globally, and since this dataset only includes 505 movies, it is safe to say that it is a sample
...
movies1 %>%
  ...
  head(1)
most_common_actor <- names(which.max(amount_actor))

```

**Your Answer:**
The actor with the most movies (in this sample) is Bruce Willis who has 8 movies (in this sample)
...
the average revenue for a Bruce Willis film is 116,280,089.57 dollars
The average revenue for all the movies is 94,815,481.64 dollars

So the average Bruce Willis movie generates more revenue than the average movie from this sample
